...
const formatMonth = (date: Moment): string => date.format('jMMMM');

const formatYear = (date: Moment): string => date.format('jYYYY');
...
export default class Calendar extends Component {
  ...
  scrollToCurrentDay = () => {
    ...
    scrollToX = dayWidthsArray
      ...
      .slice(currentDateIndex, dayWidthsArray.length)
